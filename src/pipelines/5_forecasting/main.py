...
class ArtifactExporter:
    ...
    def export(
        ...
        # 1. Proyección completa (forecast_2020_2025.csv)
        main_predictions_path = output_dir / "forecast_2020_2025.csv"
            ...
            summary_rows.append(
                {
                    ...
                    "total_accumulated_forecast_2020_2025": float(group_df["forecast_demand"].sum()),
        ...
        summary_df = pd.DataFrame(summary_rows).sort_values(
            by="total_accumulated_forecast_2020_2025", ascending=False
        )
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Paso 5 MLOps: Pronóstico recursivo multinivel (2020-2025)."
    )
